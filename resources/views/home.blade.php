                ...
                <div class="col-md-8">
                    <div class="row">
                        @foreach ($posts as $post)
                            <div class="col-md-4 col-sm-6 animate-box border-bottom border-2 mt-3"
                                ...
                                <div class="blog-entry">
                                    ...
                                    <div class="desc">
                                        <span class="blog-span">
                                            ...
                                            <small >
                                                <a
                                                    ...
                                                    class="text-decoration-none text-dark blog-span">
                                                    {{ $post->category->name }}
                                                </a>
                                            </small>
                                            |
                                        ...
                                        <h3><a class="text-decoration-none text-dark blog-title"
                                                href="blog.html">{{ $post->title }}</a></h3>
                                        <p class="blog-p">{{ $post->excerpt }}</p>
                                    </div>
                                </div>
                            </div>
                        @endforeach
